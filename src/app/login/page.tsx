      ...
      >
        <div className="bg-white/90 backdrop-blur-xl border border-amber-200/80 rounded-3xl p-8 shadow-2xl shadow-amber-950/5 relative overflow-hidden">
          ...
          <div className="mt-4 pt-3 border-t border-slate-100">
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 text-center">Quick Login Presets</p>
            <div className="flex flex-wrap gap-1.5 justify-center">
              <button
                type="button"
                onClick={() => {
                  setEmail('maheshvarjewlers70@gmail.com');
                  setPassword('705853@Wasim');
                  setErrorMsg('');
                }}
                className="px-2.5 py-1 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-200/80 rounded-xl text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1"
              >
                <span>🏪 Shop Owner (Maheshvar)</span>
              </button>
              <button
                type="button"
                onClick={() => {
                  setEmail('wasimhavaldar70@gmail.com');
                  setPassword('705853@Wasim');
                  setErrorMsg('');
                }}
                className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-900 border border-slate-300 rounded-xl text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1"
              >
